  ...
  return (
    <div className="px-28">
      ...
      <div>
        ...
        <input type="text" name="search" id="search" onChange={handleChange} className="block w-full rounded-md border px-3 py-3 outline-none border-gray-300 shadow-sm sm:text-sm" placeholder="Search contact by name" />
      </div>
      <div>
