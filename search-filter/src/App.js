  ...
  return (
    <div className="px-28">
      ...
      <div>
        ...
        <input type="text" name="search" id="search" className="block w-full rounded-md border px-3 py-3 outline-none border-gray-300 shadow-sm sm:text-sm" placeholder="Search contact by name" />
                ...
                <table className="min-w-full divide-y divide-gray-300">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    <tr key="1">
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">davidrice@gmail.com</td>
